...
public interface CarDocService {
    ...
    ApiResponse<CarDocResponse> verifyDoc(int id,CarDocRequest request,int adminId);

    ApiResponse<CarDocResponse>update(int id,CarDocRequest request);

    ApiResponse<CarDocResponse> rejectDoc(int id ,CarDocRequest request,int adminId);
